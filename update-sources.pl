...
#! nix-shell -i perl -p perl -p perlPackages.JSON -p perlPackages.FileSlurp -p perlPackages.Mojolicious -p perlPackages.DataDump -p perlPackages.IOSocketSSL -p wget
